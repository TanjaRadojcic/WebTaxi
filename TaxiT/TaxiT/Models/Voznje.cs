    ...
    public class Voznje
    {
        ...
        public Voznje(string path)
        {
            ...
            while ((line = sr.ReadLine()) != null)
            {
                ...
                Voznja p = new Voznja(Int32.Parse(tokens[0]), DateTime.Parse(tokens[1]), l, auto, Int32.Parse(tokens[11]), l2, Int32.Parse(tokens[20]), Int32.Parse(tokens[21]), Int32.Parse(tokens[22]), k, s);
